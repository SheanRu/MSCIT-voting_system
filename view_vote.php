...
<script>
    // Set the time limit in milliseconds (e.g., 30 minutes)
    var timeLimit = 30 * 60 * 1000; // 30 minutes

    // Set a timer to automatically submit the form after the time limit
    setTimeout(function () {
        $('#manage-vote').submit();
        alert('Time is up. Your vote has been automatically submitted.');
    }, timeLimit);
